const styles = {
  ...
  button: 'w-[150px] bg-black h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer transition-opacity duration-300 ease-in-out hover:opacity-70 ',
